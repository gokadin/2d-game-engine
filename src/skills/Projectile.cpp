...
Projectile::Projectile(sf::Texture *texture, MapState *mapState, float initialX, float initialY, int targetX,
        ...
        m_initialMapY(mapState->y()), m_mapState(mapState), m_flyingSpeedX(0.0f), m_flyingSpeedY(0.0f), m_damage(damage)
{
